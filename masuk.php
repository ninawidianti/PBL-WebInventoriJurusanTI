                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered data-table table table-hover" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $get = mysqli_query($c, "SELECT *, DATE_FORMAT(m.tanggal_masuk, '%d-%m-%Y') AS tanggal_masuk FROM barang_masuk m, barang b WHERE m.id_barang = b.id_barang");
                                            $i = 1;
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="jumlah mt-1">
                        ...
                        <input type="date" name="tanggal_masuk" class="form-control" placeholder="tanggal_masuk" min="1" required>
                    </div>
                    <div class="modal-footer">
