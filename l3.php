...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4 mt-5">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E301</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Barang</th>
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E302</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E303</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E304</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E305</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E306</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E307</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
        ...
        if ($data >= 1) {
            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">RUANG E308</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table table table-hover"  width="100%" cellspacing="0">
