...
<body class="bg-gradient-primary">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <h1 class="h4 text-gray-900 mb-3 text-center mt-1 font-weight-bold">Jurusan Teknologi Informasi
                        </h1>
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block ">
                                <img src="img/ilus1.png"
                                    style="width: 350px; height: 300px; margin-left: 40px; margin-top: 120px">
                            </div>
                            <div class="col-lg-7">
                                    ...
                                    <form action="proses_register.php?proses=insert" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="no_hp" name="no_hp" id="no_hp"
                                                class="form-control form-control-user" placeholder="No Hp" required>
                                        </div>
                                        <div class="form-group py">
                                            <!-- <label for="level">Level:</label> -->
                                            <div class="dropdown text-center">
                                                <button
                                                    class="form-control form-control-user dropdown-toggle text-left py-4 d-flex align-items-center"
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item" data-value="pimpinan">Pimpinan</a>
                                                    <a class="dropdown-item" data-value="user">User</a>
                                                </div>
                                                <input type="hidden" name="level" id="selectedLevel">
                                            </div>
                                        </div>
                                        <div class="form-group" id="selectedLevelDisplay" style="display: none;">
                                        </div>
    ...
    <script>
        $('.dropdown-item').on('click', function () {
            ...
            $('#selectedLevel').val(selectedValue);
            $('#dropdownMenuButton').text($(this).text());
            $('#selectedLevelText').text($(this).text());
            $('#selectedLevelDisplay').show();
        });
    </script>
