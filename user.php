            ...
            <main>
                <div class="container-fluid px-4 mb-5">
                    ...
                    <!-- <button type="button" class="btn btn-primary mb-4" data-toggle="modal"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action='./filecetak/cetakuser.php' method="post">
                        ...
                        <div class="py-0 card-body mt-3">
                            <div class="m-0 table-responsive">
                                <table class="table table-bordered data-table table table-hover" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $get = mysqli_query($c, "select * from user where level ='user'");
                                        $i = 1; //penomoran
